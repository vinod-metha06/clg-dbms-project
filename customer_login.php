...
<div>
   ...
   <form method="post" action="">
       <table width="500" align="center" bgcolor="skyblue">
           ...
           <tr align="center">
               <td align="right" colspan="3"><a href="checkout.php?forgot_pass">Forgot Password</a></td>
           </tr>


           <tr align="center">
               <td></td>
               <td colspan="3"><b><input type="submit" name="login" value="Login"/><b/></td>
           </tr>
   ...
   <?php
          if(isset($_POST['login'])){
            ...
            if($check_customer==0){
                echo"<script>alert('Password an Email is Incorrect Please try again..!')</script>";
                exit();
            }
